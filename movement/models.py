...
from lookup.models import animal_type, trans_fee_type, mode_of_transport, transfer_status, transfer_nature, \
    transfer_purpose, quarantine_reason, quarantine_status, transfer_action_type, payment_mode, payment_channel
...
class transfer(models.Model):
    ...
    transfer_nature = models.ForeignKey(transfer_nature, default=1, on_delete=models.PROTECT)
    ...
    permit_number = models.CharField(max_length=50, default='000000000')
...
class vehicle_transfer(models.Model):
    ...
    driver_permit_number = models.CharField(max_length=50, default='000000000')
    active = models.BooleanField(default=True)
    created_by = models.CharField(max_length=100, default='current_user')
    created_timestamp = models.DateTimeField(auto_now_add=True)
    updated_by = models.CharField(max_length=100, default='current_user')
...
class animal_transfer_action(models.Model):
    ...
    action_reason = models.CharField(max_length=100, default='current_user')
    active = models.BooleanField(default=True)
    created_by = models.CharField(max_length=100, default='current_user')
    created_timestamp = models.DateTimeField(auto_now_add=True)
    updated_by = models.CharField(max_length=100, default='current_user')
...
class animal_transfer_fee(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    transfer = models.ForeignKey(transfer, default=1, on_delete=models.PROTECT)
    fee_type = models.ForeignKey(trans_fee_type, default=1, on_delete=models.PROTECT)
    ...
    invoice_number = models.CharField(max_length=60, default='current_user')
