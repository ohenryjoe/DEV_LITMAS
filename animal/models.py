...
from lookup.models import sex, animal_type, breed, status, origin, dom_skin_color, ownership_change_type,animal_action_type
...
class animal(models.Model):
    ...
    dominant_colour = models.ForeignKey(dom_skin_color, default=1, on_delete=models.PROTECT)
...
class change_of_ownership(models.Model):
    ...
    ownership_change_type = models.ForeignKey(ownership_change_type, default=1, on_delete=models.PROTECT)
    active = models.BooleanField(default=False)
    created_by = models.CharField(max_length=100, default=None)
    created_timestamp = models.DateTimeField(auto_now_add=True)
    updated_by = models.CharField(max_length=100, default=None)
